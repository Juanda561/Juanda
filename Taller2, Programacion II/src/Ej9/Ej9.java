...
public class Ej9 {
    ...
    public static void main(String[] args) {
        ...
        int dias;
        float total_peaje,total_estacionamiento,Total_viaje,pago_peaje_dia,pago_estac_dia,Kilometros_totales,costo_gasolina,kilometros_conducidosXdia,total_litros_gasolina_consumidos,total_gasolina_comprada;
