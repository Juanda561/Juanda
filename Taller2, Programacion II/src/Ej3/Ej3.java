...
public class Ej3 {
    ...
    public static void main(String[] args) {
        ...
        salida.append("El Cociente es: "+Cociente(num1, num2)+"\n");
        salida.append("El Modulo es: "+Modulo(num1, num2)+"\n");
    ...
    public static float Cociente(float a, float b){
        return a/b;
    }
    
    public static float Modulo(float a, float b){
        float cociente=a/b;
        float modulo=a-(cociente*b); 
        return modulo;
    }
